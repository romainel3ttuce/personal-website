  ...
  return (
    <>
      <main className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-blue-100 flex flex-col items-center justify-center px-4">
        ...
        {/* Profile Picture - Click to Open About Window */}
        <button
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <button
            ...
            className="flex flex-col items-center gap-2 px-6 py-3 bg-white/80 backdrop-blur rounded-2xl shadow-md hover:shadow-xl transition-all hover:-translate-y-1 min-w-[100px]"
          >
      ...
      >
        <div className="space-y-3">
          <a
            ...
            className="flex items-center gap-4 p-3 rounded-xl bg-gradient-to-r from-pink-500 to-orange-500 text-white hover:opacity-90 transition-all hover:scale-105"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 p-3 rounded-xl bg-gradient-to-r from-sky-500 to-blue-500 text-white hover:opacity-90 transition-all hover:scale-105"
          >
            <span className="text-2xl">🐦</span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 p-3 rounded-xl bg-gradient-to-r from-red-500 to-rose-500 text-white hover:opacity-90 transition-all hover:scale-105"
          >
            <span className="text-2xl">🎥</span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 p-3 rounded-xl bg-gradient-to-r from-gray-700 to-gray-900 text-white hover:opacity-90 transition-all hover:scale-105"
          >
            <span className="text-2xl">💻</span>
